...
export class MenuServicesPage {
  ...
  loisirs = ['establishment','aquarium','bowling_alley','casino','shopping_center','cultural_center','fitness_center','recreation_center','movie_theater','circus','night_club','sports_complex','beach_resort','stadium','art_gallery','gym','monument','museum','opera_house','park','amusement_park','national_park','public_swimming_pool','spa','performing_arts_theater','movie_rental','movie_rental_store','zoo'];
